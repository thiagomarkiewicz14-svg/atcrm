...
export function DayEventsList({ selectedDate, events }: DayEventsListProps) {
  ...
  return (
    <section className="space-y-3">
      <div className="border-l-4 border-[#C8A951] pl-3">
        <h2 className="text-xl font-black uppercase tracking-[0.04em] text-[#1E3A2F]">{titleFormatter.format(selectedDate)}</h2>
