    ...
    <Card className="border-[#1E3A2F]/25 bg-[#F8F9F7]">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-3">
          <div>
            <CardTitle className="text-[#1E3A2F]">SEU CAMPO HOJE</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          <p className="text-xs font-black uppercase tracking-[0.1em] text-[#1E3A2F]">Top 3 prioridades</p>
          <SmartRouteCard
            variant="embedded"
        ...
        <div className="flex flex-wrap gap-2 border-t-2 border-[#1E3A2F]/10 pt-4">
          <a
            href={`https://wa.me/?text=${encodeURIComponent(summary.text)}`}
            target="_blank"
            rel="noreferrer"
            className="inline-flex min-h-9 items-center justify-center gap-2 rounded-lg bg-[#1E3A2F] px-3 text-xs font-black uppercase tracking-[0.08em] text-white transition-colors hover:bg-[#0F2D22]"
          >
          ...
          <a
            ...
            className="inline-flex min-h-9 items-center justify-center gap-2 rounded-lg border-2 border-[#1E3A2F] px-3 text-xs font-black uppercase tracking-[0.08em] text-[#1E3A2F] transition-colors hover:bg-[#1E3A2F] hover:text-white"
          >
